  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <select name="stuclass" class="form-control" required='true' id="sort" onchange="sortStudents()">
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.ClassName,tblclass.Section,tblstudent.CGPA from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass ORDER BY tblstudent.$order DESC LIMIT $offset, $no_of_records_per_page";
                          $query = $dbh->prepare($sql);
                          $query->execute();
    ...
    <script>
      function sortStudents() {
        ...
        console.log(window.location.href+"?order="+sort);
        window.location.replace((window.location.href).split("?")[0]+"?order="+sort);
      }
    </script>
